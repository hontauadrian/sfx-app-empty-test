...
describe('useEditVisualIdentityNavigationHandler', () => {
  beforeEach(() => {
  ...
  it('navigates to brandRoute when target is "saved" and clears', () => {
    ...
    renderHook(() =>
      useEditVisualIdentityNavigationHandler('brand-1', 'saved', onNavigated),
    );
  ...
  it('navigates when target is "cancel"', () => {
    ...
    const onNavigated = vi.fn();
    renderHook(() =>
      useEditVisualIdentityNavigationHandler('brand-2', 'cancel', onNavigated),
    );
  ...
  it('does nothing when target is null', () => {
    ...
    const onNavigated = vi.fn();
    renderHook(() =>
      useEditVisualIdentityNavigationHandler('brand-3', null, onNavigated),
    );
