...
import { VisualIdentityEditForm } from '../../components/VisualIdentityEditForm';
import { useEditVisualIdentity } from './use-edit-visual-identity';
import { useEditVisualIdentityNavigationHandler } from './use-edit-visual-identity-navigation-handler';
import type { EditVisualIdentityPageProps } from './types';

export function EditVisualIdentityPage({
  brandId,
}: EditVisualIdentityPageProps): ReactNode {
  const overview = useEditVisualIdentity(brandId);
  const {
    uiModel,
    handleSubmit,
    handleCancel,
  ...
  useEditVisualIdentityNavigationHandler(brandId, navigationTarget, clearNavigationTarget);
