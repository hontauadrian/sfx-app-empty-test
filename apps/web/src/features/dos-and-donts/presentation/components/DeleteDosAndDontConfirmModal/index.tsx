...
export function DeleteDosAndDontConfirmModal({
  title,
  body,
  confirmLabel,
  cancelLabel,
  ...
  onConfirm,
  onCancel,
}: DeleteDosAndDontConfirmModalProps): ReactNode {
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="delete-dos-and-dont-title"
      className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 p-4"
    >
      <div className="w-full max-w-md rounded-lg border border-border bg-card p-6">
        <h2
          id="delete-dos-and-dont-title"
