...
description: Use when defining design tokens, component specifications, CSS variables, spacing/typography scales, or strategic slide structure for design system docs. Three-layer tokens: primitive, semantic, component.
